...
function te(e, t) {
    ...
    const {
        ...
        popper: p
    } = e.offsets, d = I(e.instance.modifiers, (e) => 'applyStyle' === e.name).gpuAcceleration;
    ...
    const s = void 0 === d ? t.gpuAcceleration : d,
        ...
        g = K('transform');
    let b, w;
    if (w = 'bottom' == h ? 'HTML' === f.nodeName ? -f.clientHeight + m.bottom : -a.height + m.bottom : m.top, b = 'right' == u ? 'HTML' === f.nodeName ? -f.clientWidth + m.right : -a.width + m.right : m.left, s && g) l[g] = `translate3d(${b}px, ${w}px, 0)`, l[h] = 0, l[u] = 0, l.willChange = 'transform';
    else {
